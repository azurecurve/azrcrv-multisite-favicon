 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_mf')){
	function azrcrv_create_plugin_menu_mf(){
		azrcrv_create_plugin_menu_table_mf();
		azrcrv_populate_plugin_menu_table_mf();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_mf')){
	function azrcrv_populate_plugin_menu_table_mf(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_mf')){
	function azrcrv_create_plugin_menu_table_mf(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
