 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_msfi')){
	function azrcrv_create_plugin_menu_msfi(){
		azrcrv_populate_plugin_menu_msfi();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_msfi')){
	function azrcrv_populate_plugin_menu_msfi(){
